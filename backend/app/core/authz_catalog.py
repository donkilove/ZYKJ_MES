...
PAGE_DEFINITIONS: list[tuple[str, str, str, str | None]] = [
    ...
    ("production_pipeline_instances", "并行实例追踪", AUTHZ_MODULE_PRODUCTION, "production"),
...
ACTION_DEFINITIONS: list[tuple[str, str, str, str | None]] = [
    ...
    ("equipment.rules.list", "查看设备规则", AUTHZ_MODULE_EQUIPMENT, "equipment_rule_parameter"),
    ("equipment.rules.manage", "管理设备规则", AUTHZ_MODULE_EQUIPMENT, "equipment_rule_parameter"),
    ("equipment.runtime_parameters.list", "查看运行参数", AUTHZ_MODULE_EQUIPMENT, "equipment_rule_parameter"),
    ("equipment.runtime_parameters.manage", "管理运行参数", AUTHZ_MODULE_EQUIPMENT, "equipment_rule_parameter"),
    ...
    ("quality.defect_analysis.list", "查看不良分析", AUTHZ_MODULE_QUALITY, "quality_defect_analysis"),
    ("quality.defect_analysis.export", "导出不良分析", AUTHZ_MODULE_QUALITY, "quality_defect_analysis"),
    ...
    (PERM_PROD_PIPELINE_INSTANCES_LIST, "查看并行实例", AUTHZ_MODULE_PRODUCTION, "production_pipeline_instances"),
