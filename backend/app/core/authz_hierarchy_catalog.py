...
FEATURE_DEFINITIONS: tuple[FeatureDefinition, ...] = (
    ...
    FeatureDefinition(
        permission_code="feature.user.user_management.import",
        permission_name="批量导入用户",
        module_code="user",
        page_code="user_management",
        action_permission_codes=("user.users.import",),
        dependency_permission_codes=("feature.user.user_management.view",),
    ),
    FeatureDefinition(
    ...
    FeatureDefinition(
        permission_code="feature.product.versions.create",
        permission_name="新建产品版本",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.versions.create",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
        permission_code="feature.product.versions.copy",
        permission_name="复制产品版本",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.versions.copy",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
        permission_code="feature.product.versions.disable",
        permission_name="停用产品版本",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.versions.disable",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
        permission_code="feature.product.versions.delete",
        permission_name="删除产品版本",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.versions.delete",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
        permission_code="feature.product.versions.note_update",
        permission_name="更新产品版本备注",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.versions.note.update",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
    ...
    FeatureDefinition(
        permission_code="feature.product.version_rollback.manage",
        permission_name="回滚产品版本",
        module_code="product",
        page_code="product_version_management",
        action_permission_codes=("product.rollback",),
        dependency_permission_codes=("feature.product.version_analysis.view",),
    ),
    FeatureDefinition(
